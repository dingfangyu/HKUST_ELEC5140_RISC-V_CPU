...
HD_PWD='C:/Users/fdingad/Desktop/HKUST_ELEC5140_RISC-V_CPU/RV32i/RV32i.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RV32iPCPU.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RV32iPCPU.tcl
