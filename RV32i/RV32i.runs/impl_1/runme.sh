...
HD_PWD='C:/Users/fdingad/Desktop/HKUST_ELEC5140_RISC-V_CPU/RV32i/RV32i.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log RV32iPCPU.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source RV32iPCPU.tcl -notrace
